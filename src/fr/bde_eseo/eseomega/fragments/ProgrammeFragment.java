...
/**
 * Page affichant le programme de la liste BDE.
 * @author François
 *
 */
public class ProgrammeFragment extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView myWebView = (WebView) rootView.findViewById(R.id.progWebview);
        String mContent = "", str;
        ...
        try {
            ...
            InputStream is = getActivity().getAssets().open("programme/programme.html");
